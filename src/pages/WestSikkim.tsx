...
const [view360Modal, setView360Modal] = useState<{
  ...
  const regionData = regionsData.find(region => region.id === 'west')!;
...
const openView360 = (src: string, title: string) => {
  ...
  const openChatBot = (monasteryName: string) => {
    setChatBot({ isOpen: true, context: `${monasteryName} in West Sikkim` });
  };
        ...
        <div ref={headerRef} className="px-6 py-16">
          <div className="container mx-auto">
            ...
            <div className="flex items-start gap-4 mb-6">
              <Mountain className="w-12 h-12 text-primary mt-2" />
              <div>
            ...
            <div className="flex items-center gap-4">
              <div className="glass rounded-full px-4 py-2 flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Historical Capital</span>
              </div>
                  ...
                  <div className="flex-1 relative overflow-hidden">
                    ...
                    {monastery.id === 'tashiding' && (
                      <div className="absolute top-4 right-4 bg-gradient-mountain rounded-full px-3 py-1">
                        <span className="text-white text-xs font-medium">Most Sacred</span>
                      </div>
                    )}
                    {monastery.id === 'dubdi' && (
                      <div className="absolute top-4 right-4 bg-purple-500/20 backdrop-blur-sm rounded-full px-3 py-1">
                        <span className="text-purple-300 text-xs font-medium">First Monastery</span>
                      </div>
                    )}
                  </div>
