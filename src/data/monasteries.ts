...
export const regionsData: RegionData[] = [
    ...
    monasteries: [
      {
        ...
        image: 'https://media.istockphoto.com/id/516034386/photo/the-enchey-monastery.jpg?s=612x612&w=0&k=20&c=cia-IwV5qXeqGomM_KE55a8lu28tmLhANJFpXco7zxQ=',
  ...
  },
  {
    ...
    image: '/src/assets/Landing page img/IMG_1173.JPG',
    monasteries: [
      {
        id: 'pemayangtse',
      ...
      },
      {
        ...
        image: 'https://static.toiimg.com/photo/91382791.cms',
    ...
    monasteries: [
      {
        ...
        image: 'https://www.elginhotels.com/wp-content/uploads/2020/03/sangachoeling-monastery-01.jpg.webp',
